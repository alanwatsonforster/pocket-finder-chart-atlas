...
The positions and magnitudes of stars are taken from the Tycho-2 catalog, supplemented by the Hipparcos catalog for the very brightest stars. The positions, types, and sizes of deep sky objects are taken from the CDS SIMBAD database, supplemented by information from O’Meara’s \booktitle{Deep-Sky Companions} volumes, and the Astronomical League’s Urban Observing Program list.
