...
The positions and magnitudes are taken from the Tycho-2 catalog, supplemented by the Hipparcos catalog for the very brightest stars. Positions, types, and sizes of deep sky objects are taken from the SIMBAD database, supplemented by information from O’Meara’s \book{Deep-Sky Companions} volumes, and the Astronomical League’s Urban Observing Program list.
